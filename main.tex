...
%row no:1
\multicolumn{1}{|p{1.31in}}{Risk ID} & 
\multicolumn{1}{|p{4.71in}|}{2} \\
\hline
%row no:2
\multicolumn{1}{|p{1.31in}}{Risk Description} & 
\multicolumn{1}{|p{4.71in}|}{Loss of connectivity with AR system server} \\
\hline
%row no:3
\multicolumn{1}{|p{1.31in}}{Category} & 
\multicolumn{1}{|p{4.71in}|}{Deployment Environment} \\
\hline
%row no:4
\multicolumn{1}{|p{1.31in}}{Source} & 
\multicolumn{1}{|p{4.71in}|}{Server} \\
\hline
%row no:5
\multicolumn{1}{|p{1.31in}}{Probability} & 
\multicolumn{1}{|p{4.71in}|}{Low} \\
\hline
%row no:6
\multicolumn{1}{|p{1.31in}}{Impact} & 
\multicolumn{1}{|p{4.71in}|}{High} \\
...
%row no:8
\multicolumn{1}{|p{1.31in}}{Strategy} & 
\multicolumn{1}{|p{4.71in}|}{Making sure no other server is accessing the port used by flask server} \\
\hline
%row no:9
\multicolumn{1}{|p{1.31in}}{Risk Status} & 
\multicolumn{1}{|p{4.71in}|}{Identified} \\
\hline
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=5.43in,height=5.27in]{./media/image8.jpg}
...
\addcontentsline{toc}{section}{6.1\hspace*{10pt}Introduction}
\subsection*{6.1.1\hspace*{10pt}Project Scope}
\addcontentsline{toc}{subsection}{6.1.1\hspace*{10pt}Project Scope}
\setlength{\parskip}{0.0pt}
\begin{itemize}
	\item The project will be effectively used in Software Development Process.\par
...
\addcontentsline{toc}{subsection}{6.1.2\hspace*{10pt}User Classes and Characteristics}
\begin{justify}
...
\addcontentsline{toc}{section}{6.2\hspace*{10pt}Functional Requirements}
\subsection*{6.2.1\hspace*{10pt}Database Component Agent}
\addcontentsline{toc}{subsection}{6.2.1\hspace*{10pt}Database Component Agent}
\setlength{\parskip}{0.0pt}
\begin{itemize}
	\item Agent collects and stores defect data.\par
...
\addcontentsline{toc}{subsection}{6.2.2\hspace*{10pt}Server Component Agent}
\setlength{\parskip}{0.0pt}
\begin{itemize}
	\item Agent uses REST API for communication.\par
...
\addcontentsline{toc}{subsection}{6.2.3\hspace*{10pt}Client Component Agent}
\setlength{\parskip}{0.0pt}
\begin{itemize}
	\item An Eclipse plugin.\par
...
\addcontentsline{toc}{section}{6.3\hspace*{10pt}Non Functional Requirements}
\begin{justify}
The non-functional requirements of the system include :
\end{justify}\par
...
\addcontentsline{toc}{section}{6.4 System Requirements}
\subsection*{6.4.1 Software Requirements}
\addcontentsline{toc}{subsection}{6.4.1 Software Requirements}
\setlength{\parskip}{0.0pt}
\begin{itemize}
	\item Git.\par
...
\addcontentsline{toc}{subsection}{6.4.1 Hardware Requirements}
\setlength{\parskip}{0.0pt}
\begin{itemize}
	\item 32/64 bit Machine\par
...
\addcontentsline{toc}{section}{6.5 Analysis Models : SDLC Model to be applied}
\begin{justify}
Waterfall model :
\end{justify}\par
...
\addcontentsline{toc}{section}{6.6 System Implementation Plan}
...
\tab 7.1 Details associated with file name are fetched from database.




\tab 7.2 Number of issues, number of revisions and number of lines changed are given to built model and class is predicted against of it.
...
\addcontentsline{toc}{section}{9.1\hspace*{10pt}Type of Testing Used}
...
\addcontentsline{toc}{section}{9.2\hspace*{10pt}Test Cases and Test Results}
...
\multicolumn{1}{|p{1.73in}}{\Centering Copy the plug-in to drop in folder of Eclipse} & 
...
\multicolumn{1}{|p{1.19in}|}{\Centering Error message shows up and does not start cloning.} \\
\hline
%row no:6
